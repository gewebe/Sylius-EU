...
/**
 * Migration: SetonoSyliusTermsPlugin
 */
final class Version20231231013711 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE setono_sylius_terms__terms (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, code VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_213B63E977153098 (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE setono_sylius_terms__terms_channels (terms_id INT NOT NULL, channel_id INT NOT NULL, INDEX IDX_73B1100553742F27 (terms_id), INDEX IDX_73B1100572F5A1AA (channel_id), PRIMARY KEY(terms_id, channel_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE setono_sylius_terms__terms_channels DROP FOREIGN KEY FK_73B1100572F5A1AA');
